...
- (void)generateKeyPairRSA {
	...
	[privateKeyAttr setObject:[NSNumber numberWithBool:_isPermanent] forKey:(__bridge id)kSecAttrIsPermanent];
	[privateKeyAttr setObject:privateTag forKey:(__bridge id)kSecAttrApplicationTag];
	// See SecKey.h to set other flag values.
	
	// Set the public key dictionary.
	[publicKeyAttr setObject:[NSNumber numberWithBool:_isPermanent] forKey:(__bridge id)kSecAttrIsPermanent];
