...
final class capillaryslackTests: XCTestCase {
    ...
    func testEncryptAndDecryptWithRSA() throws {
        ...
        let encrypted = CapillaryIOS.encrypt(data: "anmol".data(using: .utf8)!, publicKey: publicKeyJVM!)
        XCTAssertNotNil(encrypted)
        
        let decrypted = CapillaryIOS.decrypt(symmetricKeyCiphertext: encrypted.first!, payloadCiphertext: encrypted.second!, privateKey: decryptedChannelPrivateKey!)
